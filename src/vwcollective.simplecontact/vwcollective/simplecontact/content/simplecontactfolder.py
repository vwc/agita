"""Definition of the SimpleContactFolder content type
"""
...
SimpleContactFolderSchema = folder.ATBTreeFolderSchema.copy() + atapi.Schema((
...
schemata.finalizeATCTSchema(
    SimpleContactFolderSchema,
    folderish=True,
    moveDiscussion=False
)

class SimpleContactFolder(folder.ATBTreeFolder):
    """A Folder holding SimpleContact information"""
    implements(ISimpleContactFolder)

    meta_type = "SimpleContactFolder"
    schema = SimpleContactFolderSchema
    ...
    def __bobo_traverse__(self, REQUEST, name):
        ...
        return super(SimpleContactFolder, self).__bobo_traverse__(REQUEST, name)

atapi.registerType(SimpleContactFolder, PROJECTNAME)
