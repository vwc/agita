...
def setup_product():
    ...
    import vwcollective.simplecontact
    zcml.load_config('configure.zcml', vwcollective.simplecontact)
    ...
    ztc.installPackage('vwcollective.simplecontact')
...
setup_product()
ptc.setupPloneSite(products=['vwcollective.simplecontact'])
